...
function Topbar() {
    return (
        <div className="topbar">
            <div className="box">
                <a className="toplink">About</a> <a className="toplink">Store</a>
            </div>
            <div className="box">
                <a className="services">Gmail</a> <a className="services">Images</a>
...
function Main() {
    ...
    return (
        <div className="main">
            ...
            <form action={query}>
                <div className="content">
                    <div className="searchform">
                        ...
                        <textarea className="index" rows="1" cols="80" expanded="false" onKeyDown={enterSearch} onChange={editSearch}></textarea>
            ...
            <p>Google offered in: Français</p>
        </div>
    );
}
...
function Bottom(){
    return (
        <div className="bottom">
            <div className="countrybar">Canada</div>
            <div className="footer">
                <div className="box"><a className="footerlink">Advertising</a> <a className="footerlink">Business</a> <a className="footerlink">How Search Works</a></div>
                <div className="box"><a className="footerlink">Privacy</a> <a className="footerlink">Terms</a> <a className="footerlink">Settings</a></div>
            </div>
        </div>
    );
}
